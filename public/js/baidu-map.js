...
var newMap = function(iframeId, modalContentId, modalId ,src) {
  return function(){
...
var initBaiduMap = function (mapId, geospatial, zoomControl, ctrfn) {
  ...
  fullscreen.addEventListener("click", fullClick);
}